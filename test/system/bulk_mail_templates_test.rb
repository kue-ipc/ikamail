...
class BulkMailTemplatesTest < ApplicationSystemTestCase
  setup do
    @bulk_mail_template = bulk_mail_templates(:one)
  end

  test "visiting the index" do
    visit bulk_mail_templates_url
  ...
  test "creating a Bulk mail template" do
    ...
    fill_in "Body footer", with: @bulk_mail_template.body_footer
    fill_in "Body header", with: @bulk_mail_template.body_header
    fill_in "Count", with: @bulk_mail_template.count
    fill_in "Description", with: @bulk_mail_template.description
    fill_in "From mail address", with: @bulk_mail_template.from_mail_address
